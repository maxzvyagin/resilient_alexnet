...
class CINIC_TensorFlow_AlexNet:
    def __init__(self, config):
        ...
        self.model = keras.models.Sequential([
            keras.layers.Conv2D(filters=64, kernel_size=(11,11), strides=4, activation='relu', input_shape=(3, 32, 32),
                                padding="same", kernel_initializer='he_uniform'),
            keras.layers.MaxPool2D(pool_size=(3,3), strides=(2, 2), padding="same"),
            keras.layers.Conv2D(filters=256, kernel_size=(5,5), strides=1, activation='relu', padding="same", kernel_initializer='he_uniform'),
            keras.layers.MaxPool2D(pool_size=(3,3), strides=(2, 2), padding="same"),
            keras.layers.Conv2D(filters=384, kernel_size=(3,3), strides=1, activation='relu', padding="same", kernel_initializer='he_uniform'),
            keras.layers.Conv2D(filters=384, kernel_size=(3,3), strides=1, activation='relu', padding="same", kernel_initializer='he_uniform'),
            keras.layers.Conv2D(filters=256, kernel_size=(3,3), strides=1, activation='relu', padding="same", kernel_initializer='he_uniform'),
            keras.layers.MaxPool2D(pool_size=(3,3), strides=(2, 2), padding="same"),
