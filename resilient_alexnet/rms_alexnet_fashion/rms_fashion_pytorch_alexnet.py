...
from resilient_alexnet.rms_alexnet_fashion.rms_opt import RMSpropTF
...
class Fashion_PyTorch_AlexNet(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        optimizer = RMSpropTF(self.parameters(), lr=self.config['learning_rate'], eps=self.config['adam_epsilon'])
        return optimizer
